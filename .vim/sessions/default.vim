...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <expr> <BS> coc#_insert_key('request', '8f47ec6b-8100-11ea-b476-a3d2d00fe42b')
...
nmap ,mf :CocCommand markdownlint.fixAll 
map ,bd :bd
map ,bp :bp
map ,bn :bn
...
nmap ,git :GitGutterToggle
nmap ,rb :RainbowParenthesesToggle 
...
imap s <Plug>Isurround
imap  <Plug>Isurround
inoremap <silent> <expr> " coc#_insert_key('request', '8f47ec69-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> ' coc#_insert_key('request', '8f47ec68-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> ( coc#_insert_key('request', '8f47ec60-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> ) coc#_insert_key('request', '8f47ec61-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> < coc#_insert_key('request', '8f47ec66-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> > coc#_insert_key('request', '8f47ec67-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> [ coc#_insert_key('request', '8f47ec62-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> ] coc#_insert_key('request', '8f47ec63-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> ` coc#_insert_key('request', '8f47ec6a-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> { coc#_insert_key('request', '8f47ec64-8100-11ea-b476-a3d2d00fe42b')
inoremap <silent> <expr> } coc#_insert_key('request', '8f47ec65-8100-11ea-b476-a3d2d00fe42b')
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set autoread
...
set mouse=a
set ruler
set runtimepath=~/.vim,~/.vim/plugged/nerdtree/,~/.vim/plugged/vim-surround/,~/.vim/plugged/vim-markdown/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/vim-airline/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/vim-colorschemes/,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/rainbow_parentheses.vim/,~/.vim/plugged/vim-racket/,~/.vim/plugged/coc.nvim/,~/.vim/plugged/papercolor-theme/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/vim-gitgutter/,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,~/.config/coc/extensions/node_modules/coc-snippets,~/.vim/plugged/vim-markdown/after,~/.vim/after
set scrolloff=3
set shiftwidth=2
...
silent only
cd ~/Desktop/reagent_app
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +79 ~/.vimrc
badd +35 ~/.config/coc/ultisnips/vim.snippets
argglobal
silent! argdel *
$argadd ~/.vimrc
edit ~/.vimrc
...
silent! normal! zE
let s:l = 88 - ((28 * winheight(0) + 25) / 51)
